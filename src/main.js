...
loader.load('/fonts/helvetiker_regular.typeface.json', function (font) {
    const textGeometry = new TextGeometry('Gaga, eu Te amo !', {
        font: font,
        size: 5,
        height: 2,
        curveSegments: 12,
...
const heartMaterial = new THREE.MeshPhongMaterial({ color: 0x69B3FF });
...
const backgroundImage = textureLoader.load('/img/gaga-em-londres.jpeg', function (texture) {
...
// Carregar a imagem de fundo
const backgroundImage2 = textureLoader2.load('/img/gaga-em-barca.jpeg', function (texture) {
    texture.wrapS = texture.wrapT = THREE.RepeatWrapping;
});
